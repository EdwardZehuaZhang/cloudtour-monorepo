...
export function MembersPanel({ orgId, currentUserRole }: MembersPanelProps) {
  ...
  const fetchMembers = useCallback(async () => {
    try {
      ...
      // Silently fail — member list will remain empty
    } finally {
      setLoading(false);
    }
  }, [orgId]);
        ...
        <SheetContent side="right">
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                <option value="viewer">Viewer — Can view tours</option>
                <option value="editor">Editor — Can create and edit tours</option>
