...
import { signup, signInWithOAuth, type AuthState } from "../actions";
...
export default function SignupPage() {
  ...
  return (
    <>
      <h1 className="mb-8 text-center font-display text-display-md text-[var(--text-primary)]">
        Create your account
      </h1>
      ...
      <form action={formAction} className="space-y-4">
        ...
        <div className="flex items-start space-x-2">
          ...
          <Label htmlFor="consent" className="text-sm leading-snug text-[var(--text-secondary)]">
            I agree to the{" "}
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-[var(--bg)] px-2 text-[var(--text-secondary)]">
            Or continue with
          </span>
        </div>
      </div>
